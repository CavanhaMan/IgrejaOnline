...
<html>
  <head>
	...
	<title>IgrejaOnLine - PESQUISAR IGREJAS</title>
  ...
  <body>
	<div id="btvoltar"><button class="btvoltar" onclick="window.location.href='index.jsp'">Voltar</button></div>
	<div class="capa">
		<h1>PESQUISAR IGREJAS</h1>
	</div>
  </body>
</html>